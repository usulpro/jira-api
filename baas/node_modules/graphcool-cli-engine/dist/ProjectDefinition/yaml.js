...
var cache = {};
function readDefinition(file, out, moduleName, args) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    vars = new Variables_1.default(out, moduleName, args);
                ...
                case 1:
                    ...
                    if (!valid) {
                        out.log(out.getErrorPrefix(moduleName) +
                            chalk_1.default.bold('Errors while validating graphcool.yml:\n'));
                        out.error(chalk_1.default.red(ajv
