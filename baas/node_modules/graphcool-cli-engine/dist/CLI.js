...
var CLI = (function () {
    ...
    CLI.prototype.run = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _a, id, dispatcher, result, plugin, foundCommand, lock, _b, checker, requests, requestsPath, topic, timeout;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 7:
                        _b.cmd = _c.sent();
                        checker = new StatusChecker_1.StatusChecker(this.config, this.cmd.env);
                    ...
                    case 10:
                        _c.sent();
                        return [3 /*break*/, 12];
                    case 11: return [2 /*return*/, new NotFound_1.NotFound(out, this.config.argv).run()];
                    case 12:
